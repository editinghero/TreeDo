    ...
    head: () => ({
      meta: [
        ...
        { title: "FarmFocus" },
        {
          name: "description",
          content:
            "ADHD-friendly task & focus timer with a playful farm reward system.",
        },
        { name: "theme-color", content: "#f4a04a" },
        ...
        },
        {
          ...
          content:
            "Turn tiny quests & focus minutes into XP, coins and a tiny pixel-pretty farm.",
        },
